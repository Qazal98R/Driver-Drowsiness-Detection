...
for i=1:size(data,2)
    ...
    tp10=[tp10;data(i).timeFeatures.TP10];
    tp9=[tp9;data(i).timeFeatures.TP9];
    af7=[af7;data(i).timeFeatures.AF7];
    af8=[af8;data(i).timeFeatures.AF8];
    label=[label;data(i).timeFeatures.labels];
